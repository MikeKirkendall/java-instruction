...
public class Request {
	...
	public Request(int id, int userID, String description, String justification, LocalDate date, String deliveryMode,
	...
	public String toString() {
		return "Request [id=" + id + ", userID=" + userID + ", description=" + description + ", justification="
				+ justification + ", date=" + date + ", deliveryMode=" + deliveryMode + ", status=" + status
